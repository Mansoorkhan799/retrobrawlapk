    ...
    <>
      ...
      <article className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-gray-300">
          ...
          <p>A bad download is one of the top causes. Uninstall Retro Brawl, then <Link href="/download-retro-brawl-apk" className="text-blue-400 underline hover:text-blue-300 font-semibold">download fresh from retrobrawlapk.com</Link>. Use stable Wi‑Fi, and scan the APK with Avast or Malwarebytes before installing.</p>
          ...
          <p>Weak or very old phones may struggle. Use <a href="https://www.bluestacks.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline hover:text-blue-300">BlueStacks</a> or another Android emulator on PC. Install Retro Brawl inside the emulator. If it lags, increase allocated RAM in emulator settings.</p>

          <h2 className="text-2xl font-bold text-[#FFA500] mt-10">Safety Tips When Downloading</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li><strong className="text-white">Use trusted sources only</strong> — <Link href="/" className="text-blue-400 underline hover:text-blue-300">retrobrawlapk.com</Link> offers verified APKs.</li>
            <li><strong className="text-white">Scan before install</strong> — Avast, Malwarebytes, or built‑in scans.</li>
            <li><strong className="text-white">Grant minimal permissions</strong> — storage and network only. Check our <Link href="/privacy" className="text-blue-400 underline hover:text-blue-300">Privacy Policy</Link> and <Link href="/disclaimer" className="text-blue-400 underline hover:text-blue-300">Disclaimer</Link>.</li>
